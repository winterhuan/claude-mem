...
import { iFlowCLIAgent, isiFlowCLISelected, isiFlowCLIAvailable } from './worker/iFlowCLIAgent.js';
...
export class WorkerService {
  ...
  private iFlowCLIAgent: iFlowCLIAgent;
  ...
  constructor() {
    ...
    this.iFlowCLIAgent = new iFlowCLIAgent(this.dbManager, this.sessionManager);
   ...
   */
  private getActiveAgent(): SDKAgent | GeminiAgent | OpenRouterAgent | iFlowCLIAgent {
    if (isiFlowCLISelected() && isiFlowCLIAvailable()) {
      return this.iFlowCLIAgent;
    }
